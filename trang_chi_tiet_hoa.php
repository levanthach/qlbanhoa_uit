    ...
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td><table width="100%" border="0">
            ...
            <tr bgcolor="#F4FBEB">
              <td>&nbsp;<a href="tim_hoa.php" class="style9">T&igrave;m ki&#7871;m b&oacute; hoa </a></td>
            </tr>
            <tr bgcolor="#F4FBEB">
              <td>&nbsp;<a href="them_hoa.php" class="style9">Th&ecirc;m m&#7899;i b&oacute; hoa </a></td>
            </tr>
          </table>		  </td>
      </tr>
      <tr>
