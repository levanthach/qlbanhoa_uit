  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#DEF4CE">
    ...
    <tr bgcolor="#F4FBEB">
      ...
      <td colspan="3" valign="middle" bgcolor="#F4FBEB"><p>&nbsp;</p>
            ...
            <td align="center">
              <p align="center"><br><br>
                ...
                <table border="1" width="700">
                  <tr >
                    <td colspan="6" align="center">Giỏ hàng của <b><?php echo $_SESSION['username'] ?></b></td>
                  </tr>
                  <tr>
                    <th>Mã bó hoa</th>
                    <th>Tên bó hoa</th>
                  ...
                  <?php 
                    ...
                    if(isset($_SESSION["cart"]))
                    {
                     ...
                     foreach ($_SESSION['cart'] as $key => $v) {
                      ...
                      echo "<td>".$v['name']."</td>";
                      echo"<td>
                      <input type='number' min='1' max='100' value='" .$v['qty']. "' name='txtsl". $v['id'] ."'/>
                      <input type='submit' name='capnhat' value='Cập nhật'/></td>"; 
                      echo "<td>".number_format($v['price'])."</td>";
                      echo "<td>". number_format($v['qty'] * $v['price'])."</td>";
                      echo "<td><a href='#' onClick='thongbaoxoa(".$v['id'].")' >Xóa</a></td>";
                      echo "</tr>";
                      $tong += $v['qty'] * $v['price'];
                    }
                  ?>
                  <tr >
                    <td colspan="6" align="right"><em>Tổng cộng:</em> <b><?php echo number_format($tong) ?></b></td>
                  </tr>
                </table>
              </form>
                <a href="index.php">Quay lại </a> || <span><a href="trang_dat_hang.php"> Đặt hàng</a></span>
        ...
        echo "Bạn cần phải đăng nhập để có thể đặt mua.<br>
...
<script language="javascript" type="text/jscript">
 function thongbaoxoa(mahoa)
 {
  ...
  if(chon==true)
    location.href = "trang_chi_tiet_gio_hang.php?mahoaxoa=" + mahoa;
}
</script>
