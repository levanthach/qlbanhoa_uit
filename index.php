...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
 ...
 <?php 
      if(isset($_POST['Submit'])){
        if(isset($_POST['ten_dn']) && $_POST['ten_dn'] != '' && isset($_POST['mat_khau']) && $_POST['mat_khau'] != ''){
    ...
    <td width="24%" valign="top"><table width="100%" border="0">
      ...
      <tr>
        ...
        echo "Xin chào <b>" .$_SESSION['username']. "</b>";
      ?>
</td>
      </tr>
      <tr>
        <td valign="top"><div align="left" class="style10">
          <?php 
        if(isset($_SESSION['username']))
          echo "<a href='trang_logout.php'>Thoát đăng nhập</a>";
?>
        </div></td>
      </tr>
    </table></td>
        ...
        echo"<table width='100%' align='center' cellpadding='5'/>";
          ...
          foreach($banghoa as $hoa)
          {
             ...
             {  
                ...
                echo "<span><a href='trang_gio_hang.php?id=".$hoa['mahoa']."'><img src='hinh_anh/gio_hang.jpg'/></a></span>";
