    ...
    <tr bgcolor="#F4FBEB">
      ...
      <td colspan="3" valign="middle" bgcolor="#F4FBEB"><p>&nbsp;</p>
        ...
        if(isset($_SESSION['username'])) { 
          $get_account = getAccount($_SESSION['username']); 
            ...
            <form name="form1" method="post" action="trang_giao_hang.php">
              <table width="400" border="0" align="center" cellpadding="0">
                <tr>
                  ...
                  <td><input name="ho_ten" type="text" id="ho_ten" value="<?php echo $value['HoTen']; ?>" size="30"></td>
                </tr>
                 <tr>
                  <td><span class="style3">Số Điện Thoại :</span></td>
                  <td><input name="dien_thoai" type="text" id="dien_thoai" value="<?php echo $value['DienThoai']; ?>" size="30"></td>
                </tr>
                 <tr>
                  <td><span class="style3">Email:</span></td>
                  <td><input name="email" type="text" id="email" value="<?php echo $value['Email']; ?>" size="30"></td>
                </tr>
                <tr>
                  <td><span class="style3">Địa chỉ giao hàng:</span></td>
                  <td><input name="dia_chi" type="text" id="dia_chi" value="<?php echo $value['DiaChi']; ?>" size="30"></td>
                </tr>
                <tr>
                  <td height="30" colspan="2" align="center"><input type="submit" name="dathang" value="Đặt hàng"></td>
                </tr>
              </table>
            </form>
